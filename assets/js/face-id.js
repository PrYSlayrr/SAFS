document.addEventListener('DOMContentLoaded', () => {
    ...
    async function loadModels() {
        try {
            await faceapi.nets.tinyFaceDetector.loadFromUri('/faceID/assets/models');
            await faceapi.nets.faceLandmark68Net.loadFromUri('/faceID/assets/models');
            await faceapi.nets.faceRecognitionNet.loadFromUri('/faceID/assets/models');
